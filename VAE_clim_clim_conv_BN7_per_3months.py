"""
Test, validation and training MSEs and biases of VAE_clim_clim_conv with 7 latent nodes
"""
...
time_max=4367 # length of validation data array divided by samples per time step 
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN7.csv')
