""" 
training of VAE_clim_clim_conv with 6 latent nodes
"""
...
VAE_clim_clim_conv.save_weights('saved_models/VAE_clim_clim_conv/VAE_clim_clim_conv_BN6_40_opt_anneal.h5')
VAE_clim_clim_conv.save_weights('saved_models/VAE_clim_clim_conv/VAE_clim_clim_conv_BN6_40_opt_anneal.tf')

hist_df = ps.DataFrame(VAE_clim_clim_conv.history.history) 

hist_csv_file = 'saved_models/VAE_clim_clim_conv/VAE_clim_clim_conv_BN6_40_opt_anneal.csv'
