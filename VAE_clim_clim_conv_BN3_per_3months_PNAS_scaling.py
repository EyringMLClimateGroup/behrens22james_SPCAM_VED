"""
MSEs and biases of VAE_clim_clim_conv with 3 latent nodes in Rasp scaling 
"""
...
### VAE_clim_clim_conv with three latent nodes 
...
VAE_clim_clim_conv.load_weights('./saved_models/VAE_clim_clim_conv/VAE_clim_clim_conv_BN3_40_opt_anneal.h5')
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN3_PNAS_scaling.csv')
