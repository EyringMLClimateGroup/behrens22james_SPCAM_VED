...
time_max=4415 #based on length of test data array divided by samples per time step 
...
time_max=4367 #based on length of validation data array divided by samples per time step 
#(lat.size*lon.size=8192)
...
time_max=4365 #based on length of training data array divided by samples per time step 
#(lat.size*lon.size=8192)
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN4.csv')
