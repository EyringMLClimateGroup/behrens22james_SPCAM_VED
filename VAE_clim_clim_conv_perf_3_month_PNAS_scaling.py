"""
this script computes the mse and bias between VAE_clim_clim_conv's SP predictions and
SP data of the test, validation and training data set with the output normalization of reference ANN (Rasp et al.,2018)
"""
...
## VAE_clim_clim_conv on Test data
...
## Save all test, validation and training scores in one csv
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN5_PNAS_scaling.csv')
