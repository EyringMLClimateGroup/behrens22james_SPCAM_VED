"""
MSEs and biases of VAE_clim_clim_conv with 4 latent nodes with respect to 
test, validation and training data in Rasp scaling
""""
...
### VAE_clim_clim_conv with four latent nodes 
...
VAE_clim_clim_conv.load_weights('./saved_models/VAE_clim_clim_conv/VAE_clim_clim_conv_BN4_40_opt_anneal.h5')
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN4_PNAS_scaling.csv')
