...
SP data of the test, validation and traing data set 
"""
...
for i in np.arange(X[:,1,1].size):
    ...
    #only predictions of VAE for SP variables [0:65] are evaluated to compare against reference ANN 
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN5.csv')
