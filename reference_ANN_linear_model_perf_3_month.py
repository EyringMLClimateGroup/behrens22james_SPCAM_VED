...
# inverse transformation to obtain absolute values of temp. tendencies,.. in respective units
...
## validation data with VAE scaling 
...
Perf_array.to_csv('perf_analy/reference_ANN_linear_model.csv')
