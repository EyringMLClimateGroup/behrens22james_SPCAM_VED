"""
calculation of MSEs and biases of VAE_clim_clim_conv with two latent nodes
"""
...
time_max=4415# obtained from length of test data array divided by samples per time step 
...
time_max=4367# obtained from length of validation data array divided by samples per time step 
#(lat.size*lon.size=8192)
...
time_max=4365 # obtained from length of training data array divided by samples per time step 
#(lat.size*lon.size=8192)
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN2.csv')
