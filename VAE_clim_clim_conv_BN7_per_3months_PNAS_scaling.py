"""
Test, validation and training MSEs and biases of VAE_clim_clim_conv with 7 latent nodes in Rasp scaling
""""
...
### VAE_clim_clim_conv with seven latent nodes 
...
batch_size = 714
latent_dim = 7 # latent space dimensions
epochs = 40    
...
VAE_clim_clim_conv.load_weights('./saved_models/VAE_clim_clim_conv/VAE_clim_clim_conv_BN7_40_opt_anneal.h5')
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN7_PNAS_scaling.csv')
