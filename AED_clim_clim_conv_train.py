"""
training of AE_clim_clim_conv network
"""
...
intermediate_dim = 463 # number of nodes in first and last hidden layers of Encoder and Decoder 
batch_size = 714
...
# training data shuffled in space and time: July, August, September of first year of SP simulations 
...
# validation data: April, May and June of second year of SP simulations 
...
AED.fit((train_gen),validation_data=(val_gen,None),epochs=40,shuffle=False,callbacks=
                              [callback_lr])


AED.save_weights('saved_models/AED_clim_clim_conv/AED_clim_clim_conv_40_opt.h5')
AED.save_weights('saved_models/AED_clim_clim_conv/AED_clim_clim_conv_40_opt.tf')

hist_df = ps.DataFrame(AED.history.history) 

hist_csv_file = 'saved_models/AED_clim_clim_conv/AED_clim_clim_conv_40_opt_history.csv'
