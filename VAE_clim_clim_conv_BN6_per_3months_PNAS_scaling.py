"""
Computing the test, validation, training MSE and bias of VAE_clim_clim_conv with 6 latent nodes in Rasp scaling
"""
...
Perf_array.to_csv('perf_analy/VAE_clim_clim_conv_BN6_PNAS_scaling.csv')
