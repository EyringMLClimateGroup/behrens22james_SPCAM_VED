"""
This script computes the MSE and biases of reference ANN (Rasp et al., 2018) for the test,
validation and training data set in the Rasp scaling
...
Perf_array.to_csv('perf_analy/reference_ANN_PNAS_scaling.csv')
